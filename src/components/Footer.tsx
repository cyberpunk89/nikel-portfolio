...
const socialLinks = [
  ...
  { 
    href: "https://www.instagram.com/noel__carter/", 
    label: "Instagram",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    ...
    <footer className="border-t-2 border-border py-8 md:py-12 mt-16 md:mt-20 bg-surface/30">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div>
            <p className="text-lg mb-4 font-mono flex items-center gap-2">
              <SaturnIcon className="w-5 h-5 text-accent" size={20} />
        ...
        <div className="mt-8 flex justify-between items-center">
          <p className="text-sm text-foreground/60 font-mono">©2026 Nikel Design</p>
          <p className="text-xs text-foreground/50 font-mono">No pixels were harmed in the making of this portfolio.</p>
        </div>
      </div>
    </footer>
  );
